...
import 'package:raqet/ui/theme/ktheme.dart';
...
class DashboardView extends StatelessWidget {
  ...
  DashboardView({Key key, this.player, this.matchResultInfos, this.changedAvatar})
      : super(key: key);
  static final GlobalKey<ScaffoldState> _scaffoldKey = new GlobalKey<ScaffoldState>();

  Widget _buildView(BuildContext context) {
    Iterable<Widget> listTiles =  player.rankingInfos.map((RankingInfoEntity item) => buildRankingInfoItem(context, item));
    
    Iterable<Widget> matcheResultsTiles = matchResultInfos.map((MatchResultInfoEntity item) => buildEventItem(context, item));
  ...
  Widget buildRankingInfoItem(BuildContext context, RankingInfoEntity rankingInfo) {
    return new Container(
      ...
      new Container(
          ...
          child: new Padding(
              ...
              child: new Text(rankingInfo.ageGroup.name,
  ...
  Widget buildEventItem(BuildContext context, MatchResultInfoEntity matchResultInfo) {
    return new Container(
        height: 50.0,
  ...
  Widget buildListTile(BuildContext context, RankingInfoEntity item) {
    return new MergeSemantics(
